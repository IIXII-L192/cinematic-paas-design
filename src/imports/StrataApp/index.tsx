import svgPaths from "./svg-z2optowgza";
...
function Group9() {
  return (
    <div className="absolute inset-[0_0_0.01%_0]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.33328 5.59429">
        <g id="Group">
...
function Icon10() {
  return (
    <div className="absolute h-[5.595px] left-[0.13px] overflow-clip top-[0.27px] w-[8.333px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.33328 5.5943">
        <g id="Group">
...
function Container2() {
  return (
    <div className="bg-[#fffcf7] relative shrink-0 w-full" data-name="Container">
...
function Text14() {
  return (
    <div className="absolute h-[18px] left-[15.74px] top-[230.98px] w-[7px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text15() {
  return (
    <div className="absolute h-[18px] left-[54.74px] top-[230.98px] w-[6px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text16() {
  return (
    <div className="absolute h-[18px] left-[91.24px] top-[230.98px] w-[10px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text17() {
  return (
    <div className="absolute h-[18px] left-[130.75px] top-[230.98px] w-[8px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text18() {
  return (
    <div className="absolute h-[18px] left-[168.25px] top-[230.98px] w-[10px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Jura:Regular',sans-serif] font-normal leading-[18px] left-[0.14px] text-[12px] text-[rgba(0,0,0,0.4)] top-[-0.61px] tracking-[0.3px] whitespace-nowrap">M</p>
      </div>
    </div>
...
function Text19() {
  return (
    <div className="absolute h-[18px] left-[208.24px] top-[230.98px] w-[7px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Jura:Regular',sans-serif] font-normal leading-[18px] left-[0.17px] text-[12px] text-[rgba(0,0,0,0.4)] top-[-0.61px] tracking-[0.3px] whitespace-nowrap">J</p>
      </div>
    </div>
...
function Text20() {
  return (
    <div className="absolute h-[18px] left-[246.74px] top-[230.98px] w-[7px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Jura:Regular',sans-serif] font-normal leading-[18px] left-[0.17px] text-[12px] text-[rgba(0,0,0,0.4)] top-[-0.61px] tracking-[0.3px] whitespace-nowrap">J</p>
      </div>
    </div>
...
function Text21() {
  return (
    <div className="absolute h-[18px] left-[284.74px] top-[230.98px] w-[8px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Jura:Regular',sans-serif] font-normal leading-[18px] left-[0.16px] text-[12px] text-[rgba(0,0,0,0.4)] top-[-0.61px] tracking-[0.3px] whitespace-nowrap">A</p>
      </div>
    </div>
...
function Text22() {
  return (
    <div className="absolute h-[18px] left-[323.24px] top-[230.98px] w-[8px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text23() {
  return (
    <div className="absolute h-[18px] left-[361.25px] top-[230.98px] w-[9px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text24() {
  return (
    <div className="absolute h-[18px] left-[399.74px] top-[230.98px] w-[9px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text25() {
  return (
    <div className="absolute h-[18px] left-[438.74px] top-[230.98px] w-[8px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text37() {
  return (
    <div className="absolute h-[18px] left-[185.13px] top-[188.14px] w-[24px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text40() {
  return (
    <div className="absolute h-[18px] left-[31.86px] top-[188.14px] w-[22px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function LeftPanel() {
  return (
    <div className="h-[3170.659px] relative shrink-0 w-full" data-name="LeftPanel">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Container120() {
  return (
    <div className="h-[73px] min-h-px relative shrink-0 w-[52px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between min-h-[inherit] relative size-full">
        <Text66 />
        <Container121 />
      </div>
    </div>
...
function Container134() {
  return <div className="absolute bg-black h-px left-[6px] rounded-[1px] top-[525.28px] w-[52px]" data-name="Container" />;
}

function ZoomScrubber() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.05)] content-stretch flex flex-col h-[526px] items-start justify-between left-[950.01px] overflow-clip px-[6px] py-[8px] rounded-[4px] top-[262.56px] w-[64px]" data-name="ZoomScrubber">
      <Container120 />
      <Container122 />
      <Container124 />
      <Container126 />
...
export default function StrataApp() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Strata App">
      <App />
    </div>
  );
}